            ...
            <div class="body">
                <div class="list-group">
                    ...
                    <?php
                        ...
                        {
                          if($temp=='')
                            { $rows[]= '<a href="'.base_url().'staf/lihat_berita_admin/'.$b['kode_brt'].'" class="list-group-item list-group-bg-teal">'.$b['judul'].'</a>'; }
    ...
    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12"> <!-- Content Side -->
        <div class="card"> <!-- External Link -->
            <div class="info-box bg-pink hover-zoom-effect">
                ...
                <div class="content">
                    <div class="text">Staf Prodi</div> <h4>EXTERNAL LINK</h4>
                </div>
            </div>
            <div class="body">
                <div class="list-group">
        ...
        <div class="card"> <!-- Download Link -->
            <div class="info-box bg-cyan hover-zoom-effect">
                ...
                <div class="content">
                    <div class="text">Staf Prodi</div> <h4>Download</h4>
                </div>
              </div>
            <div class="body">
                <div class="list-group">
