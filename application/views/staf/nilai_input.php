                    ...
                    <tbody>
                      ...
                      $tot_sks += $value['jum_sks'];
                        ...
                        echo '<td>'.$value['nama_dosen'].'</td>
                            <td>'.$value['jadwal'].'</td>
                            <td><a href="'.base_url().'staf/form_input_nilai/'.$value['nim'].'/'.$value['kd_jadwal'].'" class="btn btn-success btn-circle waves-effect waves-circle waves-float"><i class="material-icons">add_circle_outline</i></a></td>';
                      }
    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
      ...
      <?php
        ...
        if($temp=='')
        {
          ...
          <td align="center" width=10"><a href="'.base_url().'staf/hapus_nilai/'.$value['nim'].'/'.$value['kd_mk'].'"
        ...
        <td colspan="4"><strong>IP Semester : '.$ip.'</span></strong></td></tbody></table>
        <a href="'.base_url().'staf/nilai" class="btn bg-red waves-effect">Kembali</a></div>';
