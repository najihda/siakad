                    ...
                    <tbody>
                      ...
                      $tot_sks += $value['jum_sks'];
                        ...
                        echo '<td>'.$value['nama_dosen'].'</td>
                            <td>'.$value['jadwal'].'</td>
                            <td><a href="'.base_url().'admin/form_input_nilai/'.$value['nim'].'/'.$value['kd_jadwal'].'" class="btn btn-success btn-circle waves-effect waves-circle waves-float">
    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
      ...
      <?php
        ...
        if($temp=='')
        {
          ...
          <td align="center" width=10"><a href="'.base_url().'admin/hapus_nilai/'.$value['nim'].'/'.$value['kd_mk'].'"
