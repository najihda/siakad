                 ...
                 <div class="row clearfix">
                    <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
                        <div class="form-group form-float">
                            <div class="form-line">
                              <p> <b>Username</b> </p>
                                 <input value="<?php echo $u['username'];?>" name="username" type="text" class="form-control" readonly>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                      <a href="<?php echo base_url();?>admin/user_login" class="btn bg-red waves-effect"> Kembali</a>
