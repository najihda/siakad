<div class="row clearfix">
    <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12"> <!-- Content -->
         <div class="card"> <!-- Berita dari prodi untuk dosen -->
              ...
              <div class="body">
                 <div class="list-group">
                   ...
                   ?>
                   <?php
                     foreach($berita_dosen->result_array() as $b)
                         {
                           if($temp=='')
                             { $rows[]= '<a href="'.base_url().'dosen/lihat_berita/'.$b['kode_brt'].'" class="list-group-item list-group-bg-teal">'.$b['judul'].'</a>'; }
         ...
         </div> <!-- #END Berita dari prodi untuk dosen -->

         <div class="card"> <!-- Berita dari admin untuk semua -->
            ...
            <div class="body">
              <div class="list-group">
                  ...
                  <?php
                      ...
                      {
                        if($temp=='')
                          { $rows[]= '<a href="'.base_url().'dosen/lihat_berita_admin/'.$b['kode_brt'].'" class="list-group-item list-group-bg-green">'.$b['judul'].'</a>'; }
                        else if($b['judul']!=$temp)
                          { $rows[]= '<a href="'.base_url().'dosen/lihat_berita_admin/'.$b['kode_brt'].'" class="list-group-item list-group-bg-green">'.$b['judul'].'</a>'; }
                        else
                          { $rows[]= '<a href="'.base_url().'dosen/lihat_berita_admin/'.$b['kode_brt'].'" class="list-group-item list-group-bg-green">'.$b['judul'].'</a>'; }
         ...
         </div> <!-- #END Berita dari admin untuk semua -->
    </div> <!-- #END Content -->
    ...
    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12"> <!-- Content Side -->
      <div class="card"> <!-- External Link -->
          <div class="info-box bg-pink hover-zoom-effect">
              ...
              <div class="content">
                  <div class="text">Dosen</div> <h4>EXTERNAL LINK</h4>
              </div>
          </div>
          <div class="body">
              <div class="list-group">
      ...
      <div class="card"> <!-- Download Link -->
          <div class="info-box bg-cyan hover-zoom-effect">
              ...
              <div class="content">
                  <div class="text">Dosen</div> <h4>Download</h4>
              </div>
          </div>
          <div class="body">
              <div class="list-group">
