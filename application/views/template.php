...
<body class="theme-indigo">
                ...
                <div class="info-container">
                    ...
                    <div class="btn-group user-helper-dropdown">
                        ...
                        <ul class="dropdown-menu pull-right">
                            <li><a href="<?php echo base_url().'admin/profil_admin' ?>"><i class="material-icons">person</i>Profile</a></li>
            ...
            <div class="menu">
                <ul class="list">
                    ...
                    <li>
                        ...
                        <ul class="ml-menu">
                            <li> <a href="<?php echo base_url().'admin/fakultas' ?>">Fakultas</a> </li>
                            <li> <a href="<?php echo base_url().'admin/prodi' ?>">Program Studi</a> </li>
                            <li> <a href="<?php echo base_url().'admin/mk' ?>">Matakuliah</a> </li>
                            <li> <a href="<?php echo base_url().'admin/dosen' ?>">Dosen</a> </li>
                            <li> <a href="<?php echo base_url().'admin/mahasiswa' ?>">Mahasiswa</a> </li>
                            <li> <a href="<?php echo base_url().'admin/staf' ?>">Staf Prodi</a> </li>
                        </ul>
                    </li>
                    <li>
                        <a href="javascript:void(0);" class="menu-toggle">
                        ...
                        <ul class="ml-menu">
                            <li> <a href="<?php echo base_url().'admin/nilai' ?>">KHS Mahasiswa</a> </li>
                            <li> <a href="<?php echo base_url().'admin/tampil_jadwal' ?>">Jadwal Perkuliahan</a> </li>
                            <li> <a href="<?php echo base_url().'admin/thn_akademik' ?>">Tahun Akademik</a> </li>
                            <li> <a href="<?php echo base_url().'admin/kalender' ?>">Kalender Akademik</a> </li>
                        </ul>
                    </li>
                    <li>
                        <a href="<?php echo base_url().'admin/berita' ?>"> <i class="material-icons">speaker_notes</i> <span>Berita</span> </a>
                    </li>
                    <li>
                        <a href="<?php echo base_url().'admin/tentang' ?>"> <i class="material-icons">info</i> <span>About</span> </a>
                    </li>
                    <li class="header">LABELS</li>
                    <li>
                        <a href="<?php echo base_url().'admin/user_login' ?>"> <i class="material-icons col-red">donut_large</i> <span>Reset Password User</span> </a>
                    </li>
                    <li>
                        <a href="<?php echo base_url().'admin/upFileLink' ?>"> <i class="material-icons col-amber">donut_large</i> <span>Upload File & Link</span> </a>
                    </li>
                    <li>
                        <a href="<?php echo base_url().'admin/berita' ?>"> <i class="material-icons col-light-blue">donut_large</i> <span>Information</span> </a>
                    </li>
                </ul>
            </div>
            <!-- #Menu -->
    ...
    <section class="content">
        <div class="container-fluid">
          ...
          <?php echo $this->session->flashdata('hapus_thn'); ?>
          ...
          <?php echo $this->session->flashdata('hapus_mkdu'); ?>
          ...
          <?php echo $this->session->flashdata('hapus_berita'); ?>
          <?php echo $this->session->flashdata('hapus_uplink'); ?>
        <?php echo $contents; ?>
        </div>
    </section>
    <!-- Modal Large Size -->
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
              ...
              <form action="<?php echo base_url();?>index.php/admin/simpan_akun" method="post">
