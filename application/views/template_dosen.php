        ...
        <aside id="leftsidebar" class="sidebar">
                ...
                <div class="info-container">
                    ...
                    <div class="btn-group user-helper-dropdown">
                        ...
                        <ul class="dropdown-menu pull-right">
                            <li><a href="<?php echo base_url().'dosen/profil_dosen' ?>"><i class="material-icons">person</i>Profile</a></li>
            ...
            <div class="menu">
                <ul class="list">
                    ...
                    <li>
                        <a href="<?php echo base_url().'dosen/tampil_jadwal' ?>">
                    ...
                    <li>
                        <a href="<?php echo base_url().'dosen/kalender' ?>">
                            <i class="material-icons">today</i>
                            <span>Kalender Akademik</span>
                        </a>
                    </li>
                    <li>
                        <a href="<?php echo base_url().'dosen/tentang' ?>">
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
              ...
              <form action="<?php echo base_url();?>dosen/simpan_akun" method="post">
...
<!-- #END# Modal Large Size -->
    ...
    <script src="<?php echo base_url();?>assets/js/js_tambahan/jquery.validate.min.js" type="text/javascript"></script>
    <!-- Custom Js -->
